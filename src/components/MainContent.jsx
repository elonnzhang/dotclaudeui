...
function MainContent({
  ...
  return (
    <div className="h-full flex flex-col">
            ...
            <div className="min-w-0 flex items-center gap-2 flex-1 overflow-x-auto scrollbar-hide">
              {activeTab === "chat" && selectedSession && (
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center">
                  {selectedSession.__provider === "cursor" ? <CursorLogo className="w-4 h-4" /> : <ClaudeLogo className="w-4 h-4" />}
                </div>
              )}
      ...
      {editingFile && isMobile && <CodeEditor file={editingFile} onClose={handleCloseEditor} projectPath={selectedProject?.path} isSidebar={false} />}
