...
function Sidebar({
  ...
  return (
    <>
              ...
              <div className='p-6'>
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <h3 className='text-lg font-semibold text-foreground mb-2'>{t('deleteConfirmation.deleteProject')}</h3>
                    <p className='text-sm text-muted-foreground mb-1'>
                      {t('deleteConfirmation.confirmDelete')}{' '}
                      <span className='font-medium text-foreground'>{deleteConfirmation.project.displayName || deleteConfirmation.project.name}</span>?
                    </p>
                    {deleteConfirmation.sessionCount > 0 && (
                      <div className='mt-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg'>
                        ...
                        <p className='text-xs text-red-600 dark:text-red-400 mt-1'>{t('deleteConfirmation.allConversationsDeleted')}</p>
                      </div>
                    )}
                    <p className='text-xs text-muted-foreground mt-3'>{t('deleteConfirmation.cannotUndo')}</p>
                  </div>
                </div>
              </div>
              <div className='flex gap-3 p-4 bg-muted/30 border-t border-border'>
                <Button variant='outline' className='flex-1' onClick={() => setDeleteConfirmation(null)}>
                  {t('actions.cancel')}
                </Button>
                <Button variant='destructive' className='flex-1 bg-red-600 hover:bg-red-700 text-white' onClick={confirmDeleteProject}>
            ...
            <div className='bg-card border border-border rounded-xl shadow-2xl max-w-md w-full overflow-hidden'>
              <div className='p-6'>
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <h3 className='text-lg font-semibold text-foreground mb-2'>{t('deleteConfirmation.deleteSession')}</h3>
                    <p className='text-sm text-muted-foreground mb-1'>
                      {t('deleteConfirmation.confirmDelete')}{' '}
                      <span className='font-medium text-foreground'>{sessionDeleteConfirmation.sessionTitle || t('sessions.unnamed')}</span>?
                    </p>
                    <p className='text-xs text-muted-foreground mt-3'>{t('deleteConfirmation.cannotUndo')}</p>
                  </div>
                </div>
              ...
              <div className='flex gap-3 p-4 bg-muted/30 border-t border-border'>
                <Button variant='outline' className='flex-1' onClick={() => setSessionDeleteConfirmation(null)}>
                  {t('actions.cancel')}
                </Button>
                <Button variant='destructive' className='flex-1 bg-red-600 hover:bg-red-700 text-white' onClick={confirmDeleteSession}>
                  <Trash2 className='w-4 h-4 mr-2' />
                  {t('actions.delete')}
                </Button>
              </div>
      ...
      <div className='h-full flex flex-col bg-card md:select-none' style={isPWA && isMobile ? { paddingTop: '44px' } : {}}>
        {/* Header */}
        <div className='md:p-4 md:border-b md:border-border'>
          ...
          {/* Mobile Header */}
          <div className='md:hidden p-3 border-b border-border' style={isPWA && isMobile ? { paddingTop: '16px' } : {}}>
        ...
        {projects.length > 0 && !isLoading && (
          <div className='px-3 md:px-4 py-2 border-b border-border'>
            <div className='relative'>
              ...
              />
              {searchFilter && (
                <button onClick={() => setSearchFilter('')} className='absolute right-2 top-1/2 transform -translate-y-1/2 p-1 hover:bg-accent rounded'>
                                  ...
                                  >
                                    <Star
                                      className={cn(
                                        ...
                                        isStarred ? 'text-yellow-600 dark:text-yellow-400 fill-current' : 'text-gray-600 dark:text-gray-400',
                                      )}
                                    />
                                  </button>
                                  <button
                              ...
                              >
                                <Star
                                  className={cn(
                                    ...
                                    isStarred ? 'text-yellow-600 dark:text-yellow-400 fill-current' : 'text-muted-foreground',
                                  )}
                                />
                              </div>
                              <div
                                    ...
                                    <div className='flex items-center gap-2'>
                                      ...
                                      <div className='min-w-0 flex-1'>
                                        ...
                                        <div className='flex items-center gap-1 mt-0.5'>
                                          ...
                                          <span className='text-xs text-muted-foreground'>{formatTimeAgo(sessionTime, currentTime, t)}</span>
                                          {messageCount > 0 && (
          ...
          <div className='md:p-2 border-t border-border/50 flex-shrink-0'>
            ...
            <div className='hidden md:block'>
              ...
              >
                ...
                <div className='min-w-0 flex-1'>
                  <div className='text-sm font-medium text-blue-700 dark:text-blue-300'>{releaseInfo?.title || `Version ${latestVersion}`}</div>
