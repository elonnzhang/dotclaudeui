...
function AppContent() {
  ...
  window.openSettings = useCallback((tab = 'agents') => {
          ...
          {!isUpdating && !updateOutput && (
            <div className='space-y-3'>
              ...
              <div className='bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border'>
                <code className='text-sm text-gray-800 dark:text-gray-200 font-mono'>git checkout main && git pull && npm install</code>
              </div>
  ...
  return (
    <div className='fixed inset-0 flex flex-col bg-background'>
      {/* Header - always visible and centered */}
      <Header />
      ...
      <div className='flex-1 flex min-h-0'>
        ...
        <div className='flex-1 flex flex-col min-w-0'>
          <Routes>
            ...
            <Route path='/agent/new' element={<AgentDetailPage />} />
      ...
      {/* Quick Settings Panel - Only show on Project page */}
      ...
      {/* Settings Modal */}
      <Settings isOpen={showSettings} onClose={() => setShowSettings(false)} initialTab={settingsInitialTab} />
