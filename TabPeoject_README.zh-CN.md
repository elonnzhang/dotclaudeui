...
- **TaskMaster AI 集成** _(可选)_ - 通过 AI 驱动的任务规划、PRD 解析和工作流自动化实现高级项目管理
...
- **[TaskMaster AI](https://github.com/eyaltoledano/claude-task-master)** _(可选)_ - AI 驱动的项目管理和任务规划
